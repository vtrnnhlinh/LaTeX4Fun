...
\resumeSubHeadingListStart
\resumeProject
{Documents Management for Healthcare System} %Project Name
{A group project for Software Engineering class using .NET and Angular} %Project Name, Location Name
{Feb, 2024} %Event Dates

\resumeItemListStart
\item {Tools \& technologies used: GitHub, Azure, Visual Studio, Visual Studio Code, SQL Management, .NET Zero, C\#, Angular, Nodejs}
\item {Develop a Documents Management system specially for healthcare unit. Take part in developing Advanced Search feature including UI implementation and search algorithms}
\resumeItemListEnd
\vspace{-2mm}
